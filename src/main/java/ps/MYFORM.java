							...
							while (hien_danhSach_lenh) {
								...
								if (countme > 0) {
									...
									for (int k = 1; k < countme + 1; k++) {
										...
										frmRubbyMoney.setTitle("Up history   " + total_recordHistory.get(0));
									}
...
//
		 ...
		 * jss = (JavascriptExecutor) driverStock; WebElement right =
